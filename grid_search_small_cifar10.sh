...
do
    ...
    do
	python3 main.py --result_dir results/grid_search/cifar10 --dataset cifar10 --noise_rate $noise_rate --smoothing $p --batch_size 128 --noise_type symmetric --n_epoch 100 --lambda_type nll --model small
    done
done
